...
def load(wanted_commits):
    # Guardamos los commits obtenidos en un fichero json
    with open ('posibles_leaks_commits.json', 'w') as file:
        json.dump(wanted_commits, file, indent = 4) # Indent = 4 para que sea más fácil de leer
